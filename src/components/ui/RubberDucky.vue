...
const props = defineProps({
  ...
  duckColor: {
    type: String,
    default: '#FEDC00' // yellow color
  },
  beakColor: {
    type: String,
    default: '#F15623' // orange color
  },
  beakShadowColor: {
    type: String,
    default: '#9F360E' // dark orange
  },
  duckShadowColor: {
    type: String,
    default: '#E9C103' // shadow yellow
  },
  className: {
    type: String,
    default: ''
...
<template>
  <div class="ducky-container">
    <div
      v-if="showSpeechBubble"
      class="speech-bubble"
    >
        I'm listening!
        <div class="speech-source-direction"></div>
    </div>
    <svg 
      :width="width"
      :height="height"
